...
class WindowsTerminalSupport extends TerminalSupport {
  ...
  private static final int ENABLE_PROCESSED_INPUT =
      0x0001; /* Ctrl+C processed by system; also BS, CR, LF in line input mode */
  ...
  private static final int ENABLE_VIRTUAL_TERMINAL_INPUT =
      0x0200; /* Virtual terminal processing on user input */
  ...
  /**
   * It's likely this will need a recent Windows 10 or 11 build. I'm not aiming to support every old
   * Windows OS here.
   */
  @Override
  void enableRawMode() {
